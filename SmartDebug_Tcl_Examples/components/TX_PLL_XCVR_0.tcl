# Exporting Component Description of TX_PLL_XCVR_0 to TCL
# Family: PolarFire
# Part Number: MPF300TS-1FCG1152I
# Create and Configure the core component TX_PLL_XCVR_0
create_and_configure_core -core_vlnv Actel:SgCore:PF_TX_PLL:$PF_TX_PLLver -component_name {TX_PLL_XCVR_0} -params {\
"CORE:PF_TX_PLL"  \
"INIT:0x0"  \
...
"VCOFREQUENCY:1600"   }
# Exporting Component Description of TX_PLL_XCVR_0 to TCL done
