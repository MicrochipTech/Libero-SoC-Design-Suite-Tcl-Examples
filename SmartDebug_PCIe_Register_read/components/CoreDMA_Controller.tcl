# Exporting core CoreDMA_Controller to TCL
# Exporting Create design command for core CoreDMA_Controller
create_and_configure_core -core_vlnv "Actel:DirectCore:COREAXI4DMACONTROLLER:$PF_COREAXI4DMACONTROLLERver" -component_name {CoreDMA_Controller} -params {\
...
# Exporting core CoreDMA_Controller to TCL done
