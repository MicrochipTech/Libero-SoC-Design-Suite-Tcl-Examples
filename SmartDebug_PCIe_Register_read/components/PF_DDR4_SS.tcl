# Exporting core PF_DDR4_SS to TCL
# Create design TCL command for core PF_DDR4_SS
create_and_configure_core -core_vlnv "Actel:SystemBuilder:PF_DDR4:$PF_DDR4ver" -component_name {PF_DDR4_SS} -params {\
...
"ZQ_CAL_L_TIME:512" \
"ZQ_CAL_S_TIME:128" }
# Exporting core PF_DDR4_SS to TCL done
