# Exporting core CCC_111MHz to TCL
# Exporting Create design command for core CCC_111MHz
create_and_configure_core -core_vlnv "Actel:SgCore:PF_CCC:$PF_CCCver" -component_name {CCC_111MHz} -params {\
...
# Exporting core CCC_111MHz to TCL done
