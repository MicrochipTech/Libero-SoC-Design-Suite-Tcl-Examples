#------------------------------------------------------------------
# File: example.sdc
# Description: Demonstrate usage of create_generated_clock command.
#------------------------------------------------------------------
...
# Create generated clock on output port with a period twice as long
# as the period at the reference clock port.
