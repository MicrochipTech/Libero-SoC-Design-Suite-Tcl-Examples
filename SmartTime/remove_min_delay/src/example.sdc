...
# Set minimum delay for dout_q port
set_min_delay 2.1 -to [get_ports dout_q]

# Sets minimum delay by constraining all paths from din_b port.
set_min_delay 1 -from [get_ports din_b]
