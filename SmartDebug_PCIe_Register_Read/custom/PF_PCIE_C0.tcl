create_and_configure_core -core_vlnv "Actel:SgCore:PF_PCIE:$PF_PCIEver" -component_name {PF_PCIE_C0} -params {\
...
"UI_PCIE_1_CDR_REF_CLK_SOURCE:Fabric"  \
